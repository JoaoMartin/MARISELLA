...
namespace CapaNegocios
{
    public class NProducto
    {
        ...
        public static string Editar(int idProducto, string nombre, string descripcion, decimal stock, decimal precioVenta, string tipo, string estado, int idCategoria, string imprimir, 
            decimal stockMinimo, decimal costo, int? idUnidadMedida, decimal precioVentaxMayor, int? idMarca, decimal precioVenta3, decimal precioVenta4, decimal precioVenta5,
            decimal stockNroUnidades)
        {
            DProducto Obj = new DProducto();
        ...
        public static string InsertarProductoCompuesto(string nombre, string descripcion, decimal stock, decimal precioVenta, string tipo, string estado, int idCategoria, string imprimir,
            decimal stockMinimo, decimal costo, DataTable dtDetalle, int? idUnidadMedida, decimal precioVentaxMayor, int? idMarca, decimal precioVenta3, decimal precioVenta4,
            decimal precioVenta5, decimal stockNroUnidades)
        {
            DProducto Obj = new DProducto();
            Obj.Nombre = nombre;
