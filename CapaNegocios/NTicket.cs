...
namespace CapaNegocios
{
    ...
    public class NTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("CANT   PRODUCTO     KGS      P.UNI   IMPORTE");
        }
        ...
        public void AgregarTotales(string texto, decimal total)
        {
            ...
            if (texto.Length > 39)//Si es mayor a 25 lo cortamos
            {
                cortar = texto.Length - 39;
                resumen = texto.Remove(39, cortar);
            }
            else
            { resumen = texto; }
        ...
        public void AgregaArticulo(decimal cant, string articulo, decimal importe, decimal kgs, decimal pun)
        {
            ...
            if (cant.ToString().Length <= 7 && importe.ToString().Length <= 10)
            {
                ...
                if (articulo.Length > 30)
                {
                    ...
                    string subcandena = articulo.Substring(0, 8);
                    elemento += espacios + subcandena;


                    nroEspacios = ((20 - articulo.Length) - importe.ToString().Length );
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                   ...
                   */
                    ...
                    nroEspacios = ((42 - articulo.Length) - importe.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                ...
                {
                    for (int i = 0; i < (7 - cant.ToString().Length); i++)
                    {
                        espacios += " "; //Agrega espacios para completar los 20 caracteres
                    }
                    elemento = cant.ToString("#0.0#") + espacios;

                    //Colocar la cantidad a la derecha.
                    //nroEspacios = ((7 - articulo.Length) - articulo.Length);// +(20 - elemento.Length);
                    nroEspacios = 14 - articulo.Length;// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    }
                    elemento += articulo.ToString() + espacios;

                   // nroEspacios = ((15 - kgs.ToString().Length) - kgs.ToString().Length);
                    nroEspacios = 9 - kgs.ToString().Length;
                    // nroEspacios = ((kgs.ToString().Length - 14) - kgs.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    }
                    elemento += kgs.ToString() + espacios;

                    //nroEspacios = ((12 - pun.ToString().Length) - pun.ToString().Length);
                    nroEspacios = 7 - pun.ToString().Length;
                    //nroEspacios = ((pun.ToString().Length - 6) - pun.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    }
                    elemento += pun.ToString() + espacios;
                   ...
                   */
                    //Colocar el importe a la derecha.
                    //nroEspacios = ((17 -importe.ToString().Length) - importe.ToString().Length);
                    ...
                    //elemento += espacios + importe.ToString("#0.00#");
                    elemento += importe.ToString("#0.00#") + espacios;
                    linea.AppendLine(elemento);//Agregamos todo el elemento: nombre del articulo, cant, precio, importe.
                }
            }
            else
        ...
        public void AgregaArticuloRep(decimal cant, string articulo, decimal importe, decimal kgs, decimal pun)
        {
            //Valida que cant precio e importe esten dentro del rango.
            //if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            if (cant.ToString().Length <= 7 && importe.ToString().Length <= 10)
            {
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = ((15 - articulo.Length) - cant.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    ...
                    nroEspacios = ((16 - kgs.ToString().Length) - kgs.ToString().Length);
                    // nroEspacios = ((kgs.ToString().Length - 14) - kgs.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                    ...
                    elemento += espacios + kgs.ToString();

                    nroEspacios = ((11 - pun.ToString().Length) - pun.ToString().Length);
                    //nroEspacios = ((pun.ToString().Length - 6) - pun.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                    ...
                    elemento += espacios + pun.ToString();
                   ...
                   */
                    //Colocar el importe a la derecha.
                    nroEspacios = ((24 - importe.ToString().Length) - importe.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
        ...
        public void AgregaArticuloPrueba(int cant, string articulo, decimal importe)
        {
            //Valida que cant precio e importe esten dentro del rango.
            //if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
        ...
        public void AgregaArticuloReserva(int cant, string articulo,decimal importe)
        {
            //Valida que cant precio e importe esten dentro del rango.
            //if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            if (cant.ToString().Length <= 5 && importe.ToString().Length <= 8)
