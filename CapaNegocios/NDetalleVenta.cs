...
namespace CapaNegocios
{
    ...
    {
      /*  public static string InsertarAdicPedido(int idVenta, int idProducto, decimal cantidad, decimal precioVenta, decimal descuento, string nota,string tipo, string barra,
             string estado)
        {
