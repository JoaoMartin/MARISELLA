...
namespace CapaNegocios
{
    public class NVenta
    {
        ...
        public static string InsertarPedidoDividido(int? idCliente, int? idMesa, DateTime fecha, string estado, string formaPago,
            ...
            decimal adelanto, int idTrabajador_Cobro, string obs, string motivo, string cliente, string telefono, string tipoCliente, decimal saldo)
        {
            DVenta Obj = new DVenta();
            Obj.IdCliente = idCliente;
            Obj.IdMesa = idMesa;
        ...
        public static string InsertarPedidoPagadoManual(int? idCliente, int? idMesa, DateTime fecha, string estado, string formaPago, decimal descuento, int idTrabajador, string modo, int nroCaja,
                                                 ...
                                                 string tipoCliente, decimal saldo)
        {
            DVenta Obj = new DVenta();
            Obj.IdCliente = idCliente;
            Obj.IdMesa = idMesa;
     ...
     int idTrabajador_Cobro, string obs, string motivo, string cliente, string telefono, string tipoCliente)
        ...
        public static DataTable MostrarCreditosPendientes(int idCliente)
        {
            return new DVenta().mostrarCreditosPendientes(idCliente);
        }

        public static DataTable ImprimirCreditosPendientes(int idDetalle)
        {
            return new DVenta().imprimirCreditosPendientes(idDetalle);
        }
        ...
        public static DataTable BuscarReporteVentaFechas_Cliente(string textoBuscar, DateTime fechaInicio, DateTime fechaFin)
        {
            DVenta Obj = new DVenta();
            return Obj.BuscarReporteVentasFecha_Cliente(textoBuscar, fechaInicio, fechaFin);
        }
        ...
        public static DataTable mostrarTotalCreditoAbono(int idPersona)
        {
            DVenta Obj = new DVenta();
            return Obj.MostrarTotalCreditoAbono(idPersona);
        }

        public static DataTable mostrarTotalCreditoVenta()
        {
            DVenta Obj = new DVenta();
            return Obj.MostrarTotalCreditoVenta();
        }
