...
namespace CapaPresentacion
{
    public partial class frmPagar : Form
    {
        ...
        private void ValidarAcceso()
        {
            ...
            {
                if (dtNivel.Rows[i][2].ToString() == "PVenta_Dcto General")
                {
        ...
        private void frmPagar_Load(object sender, EventArgs e)
        {
            ...
            if (lblBanderaCobro.Text == "0")
            {
                ...
                btnDescuentoTotal.Visible = true;
            ...
            if (rbCreditoEmitido.Checked == true)
            {
                ...
                this.lblVuelto.Text = "SALDO";
                this.lblAdelanto.Visible = true;
                this.lblMontoAdelanto.Visible = true;
                this.lblSAdelanto.Visible = true;
                mostrarTotales();
            ...
            if (lblBanderaCobro.Text == "0" || lblBanderaCobro.Text == "3")
            {
                ...
                else if (rbCreditoEmitido.Checked == true)
                {
                    if (this.txtEfectivo.Text.Trim().Length > 0)
                    {
                        ...
                        this.txtVuelto.Text = vuelto.ToString();
                        this.lblMontoAdelanto.Text = efectivo.ToString("#0.00#");
                    }else
                    {
                        this.txtVuelto.Text = lblTotal.Text;
                    }
        ...
        private bool insertarCaja()
        {
            ...
            try
            {
                ...
                else if (rbCreditoEmitido.Checked == true || rbCredioNEm.Checked == true)
                {
                    ...
                    {
                        adelanto = Convert.ToDecimal(txtEfectivo.Text);
                    }
                    rptaCaja = NCaja.Insertar(Convert.ToInt32(this.lblIdUsuario.Text), "1", "Ingreso",adelanto, "VENTA-ADELANTO", "EFECTIVO");
                    if (rptaCaja == "OK")
                    {
                        return true;
                    }
...
frmReservar.f1.txtNombre.Text.ToUpper().Trim(), frmReservar.f1.txtCel.Text.Trim(), lblClase.Text);
        ...
        private void Cobrar()
        {
            ...
            else if (rbCreditoEmitido.Checked == true && Convert.ToDecimal(txtVuelto.Text) <= 0)
            {
                MessageBox.Show("El adelanto supera al monto total");
                this.txtEfectivo.Focus();
            }
            else
            {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (verMontosPago() == true)
                            {
                                ...
                                {
                                    string tipoCompr = "";
                                    if (this.lblBanderaComprobante.Text == "0")//PARA NOTA DE PEDIDO
                                    {
                                        tipoCompr = "NOTA DE PEDIDO";
                                    }
                                    else
                                    {
                                        tipoCompr = "BOLETA";
                                    ...
                                    if (lblFechaEntrega.Text == "1")
                                    {
                                        if (rbEfectivo.Checked == true || rbTarjeta.Checked == true || rbMixto.Checked == true || rbConsumoT.Checked == true)
                                        {
                                            rpta = NVenta.InsertarPedidoPagado(idCliente, null, frmVenta.f1.dtFecha.Value,
                                                estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                            ...
                                                                            frmVenta.f1.dtFecha.Value, Convert.ToDecimal(lblTotal.Text), 
                                                                             Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text),
                                                                             this.lblObs.Text, "", "", "", lblClase.Text, 00.00m);
                                        }
                                        else if (rbCreditoEmitido.Checked == true)
                                        {
                                            decimal adelanto = 00.00m;
                                            ...
                                            {
                                                adelanto = Convert.ToDecimal(txtEfectivo.Text.Trim());
                                            }
                                            rpta = NVenta.InsertarPedidoPagado(idCliente, null, Convert.ToDateTime(frmVenta.f1.dtFecha.Value), estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                             , Convert.ToInt32(this.lblIdUsuario.Text), "CU", 1, tipoCompr, 1, Convert.ToDecimal(this.lblIgv.Text), "EMITIDA",
                                                                             Convert.ToDecimal(this.lblTotal.Text), pagoEfectivo, pagoTarjeta, 00.00m, frmVenta.f1.dtDetalle, vuelto,
                                                                          Convert.ToDateTime(frmVenta.f1.dtFecha.Value), adelanto,
                                                                             Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text), this.lblObs.Text, "", "", "", lblClase.Text,
                                                                             Convert.ToDecimal(txtVuelto.Text));
                                        }
                                        else if (rbCortesia.Checked == true)
                                        {
                                            rpta = NVenta.InsertarPedidoPagadoCredCor(idCliente, Convert.ToInt32(this.lblIdMesa.Text), Convert.ToDateTime(frmVenta.f1.dtFecha.Value),
                                                estadoVenta, 
                                                formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                            , Convert.ToInt32(this.lblIdUsuario.Text), "CU", 1, frmVenta.f1.dtDetalle,
                                                                           Convert.ToDateTime(frmVenta.f1.dtFecha.Value), Convert.ToDecimal(lblTotal.Text), Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text),
                                                                            this.lblObs.Text, "", "", "", lblClase.Text, 00.00m);
                                        }
                                    ...
                                    {
                                        rpta = NVenta.InsertarPedidoPagadoR(idCliente, Convert.ToInt32(this.lblIdMesa.Text), Convert.ToDateTime(frmVenta.f1.dtFecha.Value),
                                            estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                              , Convert.ToInt32(this.lblIdUsuario.Text), "CU", 1, tipoCompr, 1, Convert.ToDecimal(this.lblIgv.Text), "EMITIDA",
                                                                              Convert.ToDecimal(this.lblTotal.Text), pagoEfectivo, pagoTarjeta,
                                                                              00.00m, frmVenta.f1.dtDetalle, vuelto,
                                                                          Convert.ToDateTime(frmVenta.f1.dtFecha.Value), Convert.ToDecimal(lblTotal.Text), Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text),
                                                                              ...
                                                                              frmReservar.f1.txtCel.Text.Trim(), lblClase.Text, 00.00m);
                                    }
                                    ...
                                    if (rpta != "")
                                    {
                                        ...
                                        if (insertarCaja() == true)
                                        {
                                            ...
                                            if (count != frmVenta.f1.dtDetalle.Rows.Count)
                                            {
                                                if (rbEfectivo.Checked == true || rbTarjeta.Checked == true || rbMixto.Checked == true || rbCreditoEmitido.Checked == true || rbConsumoT.Checked == true)
                                                {
                                                    NImprimir_Comprobante.imprimirCom(Convert.ToInt32(rpta), tipoCompr, this.txtNombre.Text.Trim(), this.txtDireccion.Text.Trim(),
                                                                   ...
                                                                   frmVenta.f1.dataListadoDetalle, this.lblDescuento.Text, this.lblDctoGeneral.Text, this.lblSubTotal.Text,
                                                                   this.lblIgv.Text, this.lblTotal.Text, efectivo1, vuelto1, tarjeta1, formaPago1, modoProd, "00.00", "",
                                                                   NAliento.MensajeAliento(), frmVenta.f1.dtFecha.Value.ToLongDateString(),txtEfectivo.Text,txtVuelto.Text);
                                                    NImprimir_Comprobante.imprimirCom(Convert.ToInt32(rpta), tipoCompr, this.txtNombre.Text.Trim(), this.txtDireccion.Text.Trim(),
                                                                   this.txtDocumento.Text.Trim(), frmVenta.f1.lblMesero.Text, "", "",
                                                                   frmVenta.f1.dataListadoDetalle, this.lblDescuento.Text, this.lblDctoGeneral.Text, this.lblSubTotal.Text,
                                                                   this.lblIgv.Text, this.lblTotal.Text, efectivo1, vuelto1, tarjeta1, formaPago1, modoProd, "00.00", "",
                                            ...
                                            lblIdVenta.Text = "";
                                            this.Close();
                                            frmVenta.f1.cargarProducto();
                                            frmVenta.f1.LimpiarTodo();
                                            frmVenta.f1.lblIdVenta.Text = "0";
                                            frmVenta.f1.txtIdCliente.Text = "";
                                            frmVenta.f1.txtNombreCliente.Text = "";
                                            frmVenta.f1.txtDocumento.Text = "";
                                ...
                                else
                                {
                                    if (this.txtIdCliente.Text.Trim() != string.Empty && this.txtDocumento.Text.Trim().Length == 11)
                                    {
                                        ...
                                        if (lblFechaEntrega.Text == "1")
                                        {
                                            if (rbEfectivo.Checked == true || rbTarjeta.Checked == true || rbMixto.Checked == true || rbConsumoT.Checked == true)
                                            {
                                                rpta = NVenta.InsertarPedidoPagado(idCliente, Convert.ToInt32(this.lblIdMesa.Text), frmVenta.f1.dtFecha.Value, estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                             ...
                                                                             frmVenta.f1.dtFecha.Value, Convert.ToDecimal(lblTotal.Text),
                                                                             Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text), this.lblObs.Text, "", "", "", lblClase.Text, 00.00m);
                                            }
                                            else if (rbCortesia.Checked == true)
                                            {
                                                rpta = NVenta.InsertarPedidoPagadoCredCor(idCliente, Convert.ToInt32(this.lblIdMesa.Text), frmVenta.f1.dtFecha.Value, estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                          , Convert.ToInt32(this.lblIdUsuario.Text), "CU", 1, frmVenta.f1.dtDetalle,
                                                                          frmVenta.f1.dtFecha.Value, Convert.ToDecimal(lblTotal.Text), Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text),
                                                                          this.lblObs.Text, "", "", "", lblClase.Text, 00.00m);
                                            }
                                            else if (rbCreditoEmitido.Checked == true)
                                            {
                                                ...
                                                rpta = NVenta.InsertarPedidoPagado(idCliente, Convert.ToInt32(this.lblIdMesa.Text), frmVenta.f1.dtFecha.Value, estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                             ...
                                                                             "EMITIDA", Convert.ToDecimal(this.lblTotal.Text), pagoEfectivo,
                                                                             pagoTarjeta, 00.00m, frmVenta.f1.dtDetalle, vuelto,
                                                                             frmVenta.f1.dtFecha.Value, adelanto,
                                                                             Convert.ToInt32(frmPrincipal.f1.lblIdUsuario.Text), this.lblObs.Text, "", "", "", lblClase.Text,
                                                                             Convert.ToDecimal(txtVuelto.Text));
                                            }
                                        ...
                                        {
                                            rpta = NVenta.InsertarPedidoPagadoR(idCliente, Convert.ToInt32(this.lblIdMesa.Text), frmVenta.f1.dtFecha.Value, estadoVenta, formaPago, Convert.ToDecimal(this.lblDctoGeneral.Text)
                                                                             , Convert.ToInt32(this.lblIdUsuario.Text), "CU", 1, "FACTURA", 1, Convert.ToDecimal(this.lblIgv.Text),
                                                                             "EMITIDA", Convert.ToDecimal(this.lblTotal.Text), pagoEfectivo,
                                                                             pagoTarjeta, 00.00m, frmVenta.f1.dtDetalle, vuelto,
                                                                             frmVenta.f1.dtFecha.Value, Convert.ToDecimal(lblTotal.Text),
        ...
        private void ValidarDcto()
        {
            DataTable dtClienteVenta;
            dtClienteVenta = NCliente.mostrarClienteVenta(frmVenta.f1.txtDocumento.Text);
            if (lblClase.Text == "C")
            {
