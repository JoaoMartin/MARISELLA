...
namespace CapaPresentacion
{
    public partial class frmAdelanto : Form
    {
        ...
        private void Mostrar()
        {
            if (IsNuevo)
            {
                this.dataListado.DataSource = NAdelanto.Mostrar(Convert.ToInt32(cbTrabajador.SelectedValue));
                cbTraba.SelectedValue = cbTrabajador.SelectedValue;
            }else
            {
                this.dataListado.DataSource = NAdelanto.Mostrar(Convert.ToInt32(cbTraba.SelectedValue));
            }
