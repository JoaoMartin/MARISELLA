...
namespace CapaPresentacion
{
    public partial class frmDescuentoTrabajador : Form
    {
        ...
        private void Mostrar()
        {
            if (IsNuevo)
            {
                this.dataListado.DataSource = NDescuentoTrabajador.Mostrar(Convert.ToInt32(cbTrabajador.SelectedValue));
                cbTraba.SelectedValue = cbTrabajador.SelectedValue;
            }
            else
            {
                this.dataListado.DataSource = NDescuentoTrabajador.Mostrar(Convert.ToInt32(cbTraba.SelectedValue));
            }
