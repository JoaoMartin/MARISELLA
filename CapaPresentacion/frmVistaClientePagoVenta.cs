...
namespace CapaPresentacion
{
    ...
    {
        public static frmVistaClientePagoVenta f1;
        public frmVistaClientePagoVenta()
        {
            InitializeComponent();
            frmVistaClientePagoVenta.f1 = this;
        }
        ...
        private void dataListado_Click(object sender, EventArgs e)
        {
            ...
            {
                frmVenta.f1.txtIdCliente.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Codigo"].Value);
                frmVenta.f1.txtNombreCliente.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Cliente"].Value);
                frmVenta.f1.txtDocumento.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Nro_Doc"].Value);
                frmVenta.f1.lblTipoCliente.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Clase"].Value);
                frmVenta.f1.lblDireccion.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Direccion"].Value);
                this.Close();
            }
        }
        ...
        {
            frmClienteRapido frm = new frmClienteRapido();
            frm.ShowDialog();
        }
    }
}
