...
{
    public partial class frmRTrabajador : Form
    {
        public frmRTrabajador()
        {
            InitializeComponent();
        }

        private void frmRTrabajador_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                /* repdoc.Load(@"C:\Users\vioma\OneDrive\Documentos\Visual Studio 2017\Projects\SisVentas_ResAlm\CapaPresentacion\Reportes/RTrabajador.rpt");
                 ...
                 */
                repdoc.Load(@"D:\Reportes\RTrabajador.rpt");
                crConnectionInfo.ServerName = @"EQUIPO\SQLEXPRESS";
