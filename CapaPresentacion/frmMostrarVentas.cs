...
namespace CapaPresentacion
{
    public partial class frmMostrarVentas : Form
    {
        ...
        private void dataListado_Click(object sender, EventArgs e)
        {
            ...
            this.lblCliente.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["nomCliente"].Value);
        ...
        private void BuscarCliente()
        {
            ...
            this.dataListado.DataSource = NVenta.BuscarReporteVentaFechas_Cliente(this.txtBuscar.Text.Trim(), Convert.ToDateTime(fechaInicio), Convert.ToDateTime(fechaFin));
            this.ocultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            if (rbNroComp.Checked == true && txtBuscar.Text.Trim().Length > 0)
            {
                BuscarCliente();
            }
            else if (rbNroComp.Checked == true && txtBuscar.Text.Trim().Length == 0)
            {
                Mostrar();
            }
        }
