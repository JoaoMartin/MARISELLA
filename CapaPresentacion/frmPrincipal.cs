...
namespace CapaPresentacion
{
    public partial class frmPrincipal : Form
    {
        ...
        private void otrasComprasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmOtrasCompras frm = new frmOtrasCompras();
            frm.MdiParent = this;
            frm.Show();
        ...
        {
            frmMostrarTransporte frm = new frmMostrarTransporte();
            frm.MdiParent = this;
            frm.Show();
            frm.dataListado.ClearSelection();
        }
        ...
        {
            frmMostrarRegistroTrabajador frm = new frmMostrarRegistroTrabajador();
            frm.MdiParent = this;
            frm.Show();
            frm.dataListado.ClearSelection();
        }

        private void deudasCreditoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmMostrarDeudaCreditos frm = new frmMostrarDeudaCreditos();
            frm.MdiParent = this;
            frm.Show();
            frm.dataListado.ClearSelection();
            frm.dataListadoSinAbonr.ClearSelection();
        }
