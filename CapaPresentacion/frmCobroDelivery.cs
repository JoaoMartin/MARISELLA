                        ...
                        if(rpta == "OK")
                        {
                            ...
                            if(rpta == "OK")
                            {
                               ...
                               /* NImprimir_Comprobante.imprimirCom(Convert.ToInt32(this.lblIdVenta.Text), this.lblTipoComprobante.Text, this.lblCliente.Text, this.lblDireccion.Text,
                                    ...
                                    total.ToString(), this.lblVuelto.Text, "00.00", "EFECTIVO", "Detallado","00.00",this.lblTelefono.Text,NAliento.MensajeAliento(),frmVenta.f1.dtFecha.Value.ToLongDateString());
            ...
            try
            {
                ...
                else if (this.lblEstado.Text == "Enviado")
                {
                    ...
                    if (rpta == "OK")
                    {
                            ...
                            frm.lblIdCompra.Text = dtIdCompr.Rows[0][3].ToString();
