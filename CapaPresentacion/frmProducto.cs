...
namespace CapaPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void Limpiar()
        {
            ...
            this.txtPrecioVentaxMayor.Text = string.Empty;
            this.txtPrecV3.Text = string.Empty;
            this.txtPrecioV4.Text = string.Empty;
            this.txtPV5.Text = string.Empty;
            this.txtNroUnidadesActual.Text = string.Empty;
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.txtPrecioVentaxMayor.ReadOnly = !valor;
            this.txtPrecV3.ReadOnly = !valor;
            this.txtPrecioV4.ReadOnly = !valor;
            this.txtPV5.ReadOnly = !valor;
            this.txtNroUnidadesActual.ReadOnly = !valor;
        ...
        private void ocultarColumnas()
        {
           ...
           // this.dataListado.Columns[1].Visible = false;
            ...
            this.dataListado.Columns[3].Width = 235;
            ...
            this.dataListado.Columns[10].Width = 97;
            this.dataListado.Columns[11].Width = 97;
        ...
        {
            this.dataListado.DataSource = NProducto.BuscarMarcaProducto(this.txtBuscar.Text.Trim());
            this.ocultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            cbMarca.DataSource = NMarca.Mostrar();
        ...
        private void Guardar()
        {
            try
            {
                ...
                int? idUnidad = null;
                int? idMarca = null;
                decimal stock = 00.00m, stockNroUnidades = 00.00m;
                decimal stockMinimo = 00.00m;
                string sTexto = "";
                string imprimir = "";
                decimal precioVenta3 = 00.00m, precioVenta4 = 00.00m, precioVenta5 = 00.00m;
                ...
                else if (this.txtPrecioVenta.Text.Trim() != string.Empty)
                {
                    ...
                    {
                        decimal precioVentaxMayor = 00.00m;
                        ...
                        if(txtPrecioVentaxMayor.Text.Trim().Length == 0)
                        {
                            precioVentaxMayor = 00.00m;
                        }else
                        {
                            precioVentaxMayor = Convert.ToDecimal(txtPrecioVentaxMayor.Text.Trim());
                            
                        }

                        if(txtPrecV3.Text.Trim().Length == 0)
                        {
                            precioVenta3 = 00.00m;
                        }else
                        {
                            precioVenta3 = Convert.ToDecimal(txtPrecV3.Text.Trim());
                        }

                        if(txtPrecioV4.Text.Trim().Length == 0)
                        {
                            precioVenta4 = 00.00m;
                        }else
                        {
                            precioVenta4 = Convert.ToDecimal(txtPrecioV4.Text.Trim());
                        }
                        ...
                        {
                            precioVenta5 = Convert.ToDecimal(txtPV5.Text.Trim());
                        }

                        if (txtNroUnidadesActual.Text.Trim().Length == 0)
                        {
                            stockNroUnidades = 00.00m;
                        }
                        else
                        {
                            stockNroUnidades = Convert.ToDecimal(txtNroUnidadesActual.Text.Trim());
                        }
                        ...
                        if (this.IsNuevo)
                        {
                            if (rbCompuesto.Checked == true)
                            {
                                rpta = NProducto.InsertarProductoCompuesto(this.txtNombre.Text.Trim().ToUpper(), txtDescripcion.Text.Trim(),stock,
                                                  ...
                                                  precioVentaxMayor,idMarca, precioVenta3,precioVenta4,precioVenta5,stockNroUnidades);

                            }
                            else
                            {
                                rpta = NProducto.Insertar(this.txtNombre.Text.Trim().ToUpper(), txtDescripcion.Text.Trim(), stock,
                                                  Convert.ToDecimal(this.txtPrecioVenta.Text.Trim()), tipo, "A", idCategoria, imprimir, stockMinimo, 00.00m, idUnidad,precioVentaxMayor,
                                                  idMarca, precioVenta3,precioVenta4,precioVenta5,stockNroUnidades);
                        ...
                        else
                        {
                            if (rbCompuesto.Checked == true)
                            {
                                ...
                                rpta = NProducto.Editar(Convert.ToInt32(this.txtIdProducto.Text), this.txtNombre.Text.Trim().ToUpper(), txtDescripcion.Text.Trim(), stock,
                                   Convert.ToDecimal(this.txtPrecioVenta.Text.Trim()), tipo, "A", idCategoria, imprimir, stockMinimo, 00.00m, idUnidad,precioVentaxMayor,idMarca,
                                   precioVenta3,precioVenta4,precioVenta5,stockNroUnidades);
        ...
        {
            string tipo;
            string idCategoria, idUnidad, idMarca;
            if (this.IsNuevo)
            {
                this.Habilitar(false);
            ...
            this.txtStockActual.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Stock_Kg"].Value);

            //this.cbCategoria.SelectedItem = Convert.ToString(this.dataListado.CurrentRow.Cells["Categoria"].Value);
            this.txtPrecioVenta.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["PVxMenor"].Value);
            this.txtPrecioVentaxMayor.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["PVxMayor"].Value);
            this.txtPrecV3.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["PV_3"].Value);
            this.txtPrecioV4.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["PV_4"].Value);
            this.txtPV5.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["PV_5"].Value);
            this.txtNroUnidadesActual.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["Stock_Unidades"].Value);
           ...
           // idMarca= Convert.ToString(this.dataListado.CurrentRow.Cells["idMarca"].Value);
        ...
        private void txtPrecioVentaxMayor_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 8)
            {
                e.Handled = false;
            ...
            for (int i = 0; i < txtPrecioVentaxMayor.Text.Length; i++)
            {
                if (txtPrecioVentaxMayor.Text[i] == '.')
                    IsDec = true;
        ...
        private void txtPrecV3_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 8)
            {
                e.Handled = false;
            ...
            for (int i = 0; i < txtPrecV3.Text.Length; i++)
            {
                if (txtPrecV3.Text[i] == '.')
                    IsDec = true;
        ...
        private void txtPrecioV4_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 8)
            {
                e.Handled = false;
            ...
            for (int i = 0; i < txtPrecioV4.Text.Length; i++)
            {
                if (txtPrecioV4.Text[i] == '.')
                    IsDec = true;
