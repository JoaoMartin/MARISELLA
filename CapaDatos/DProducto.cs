...
namespace CapaDatos
{
    public class DProducto
    {
        ...
        private decimal _PrecioVenta3;
        private decimal _PrecioVenta4;
        private decimal _PrecioVenta5;
        private decimal _StockNroUnidades;
        ...
        public decimal PrecioVenta4
        {
            get
            {
                return _PrecioVenta4;
            }
        ...
        public decimal PrecioVenta5
        {
            get
            {
                return _PrecioVenta5;
            }
        ...
        public decimal StockNroUnidades
        {
            get
            {
                return _StockNroUnidades;
            }

            set
            {
                _StockNroUnidades = value;
            }
        }
        ...
        public DProducto(int idProducto, string nombre, string descripcion, decimal stock, decimal precioVenta, string tipo, string estado, int idCategoria, string textoBuscar, 
            string imprimir, decimal stockMinimo, decimal costo, int idUnidadMedida, decimal stockTienda, decimal precioVentaxMayor, int idMarca, decimal precioVenta3, decimal precioVenta4,
            decimal precioVenta5, decimal stockNroUnidades)
        {
            ...
            this.StockNroUnidades = stockNroUnidades;
        }
        ...
        public string Insertar(DProducto Producto)
        {
            ...
            try
            {
                ...
                SqlParameter ParPrcioVenta3 = new SqlParameter();
                ParPrcioVenta3.ParameterName = "@precioVenta_3";
                ParPrcioVenta3.SqlDbType = SqlDbType.Decimal;
                ParPrcioVenta3.Precision = 8;
                ParPrcioVenta3.Scale = 2;
                ParPrcioVenta3.Value = Producto.PrecioVenta3;
                sqlCmd.Parameters.Add(ParPrcioVenta3);

                SqlParameter ParPrcioVenta4 = new SqlParameter();
                ParPrcioVenta4.ParameterName = "@precioVenta_4";
                ParPrcioVenta4.SqlDbType = SqlDbType.Decimal;
                ParPrcioVenta4.Precision = 8;
                ParPrcioVenta4.Scale = 2;
                ParPrcioVenta4.Value = Producto.PrecioVenta4;
                sqlCmd.Parameters.Add(ParPrcioVenta4);

                SqlParameter ParPrcioVenta5 = new SqlParameter();
                ParPrcioVenta5.ParameterName = "@precioVenta_5";
                ParPrcioVenta5.SqlDbType = SqlDbType.Decimal;
                ParPrcioVenta5.Precision = 8;
                ParPrcioVenta5.Scale = 2;
                ParPrcioVenta5.Value = Producto.PrecioVenta5;
                sqlCmd.Parameters.Add(ParPrcioVenta5);

                SqlParameter ParNroUnidades = new SqlParameter();
                ParNroUnidades.ParameterName = "@stockNroUnidades";
                ParNroUnidades.SqlDbType = SqlDbType.Decimal;
                ParNroUnidades.Precision = 8;
                ParNroUnidades.Scale = 2;
                ParNroUnidades.Value = Producto.StockNroUnidades;
