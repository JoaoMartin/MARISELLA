...
namespace CapaDatos
{
    public class DVenta
    {
        ...
        public DVenta(int idVenta, int idCliente,  int idMesa, DateTime fecha, string estado, string formaPago, decimal descuento, int idTrabajador, 
            ...
            string motivo, string cliente, string telefono, string tipoCliente, decimal saldo)
        {
        ...
        public DataTable BuscarReporteVentasFecha_Cliente(string textoBuscar, DateTime fechaInicio, DateTime fechaFin)
        {
            DataTable dtResultado = new DataTable("Venta");
            SqlConnection sqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_BuscarReporteVentasFecha_Cliente";
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable mostrarCreditosPendientes(int idCliente)
        {
            DataTable dtResultado = new DataTable("Pedidos");
            SqlConnection sqlCon = new SqlConnection();
            try
        ...
        public DataTable imprimirCreditosPendientes(int idDetalle)
        {
            DataTable dtResultado = new DataTable("Pedidos");
            SqlConnection sqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_imprimirCreditosPendientes";
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable MostrarTotalCreditoAbono(int idPersona)
        {
            DataTable dtResultado = new DataTable("Venta");
            SqlConnection sqlCon = new SqlConnection();
        ...
        public DataTable MostrarTotalCreditoVenta()
        {
            DataTable dtResultado = new DataTable("Venta");
            SqlConnection sqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_mostrarTotalCreditoVenta";
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable MostrarTotalCreditoVentaCliente(int idPersona)
        {
            DataTable dtResultado = new DataTable("Venta");
            SqlConnection sqlCon = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_mostrarTotalCreditoVenta_Cliente";
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable mostrarNroDetalle(int idVenta)
        {
            DataTable dtResultado = new DataTable("Pedidos");
            SqlConnection sqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_nroDetalle";
                sqlCmd.CommandType = CommandType.StoredProcedure;
