...
namespace CapaDatos
{
    public class DAdelanto
    {
        ...
        public DataTable Mostrar(int idTrabajador)
        {
        ...
        public DataTable reporteAdelanto(DateTime fechaInicio, DateTime fechaFin, string estado, int idTrabajador)
        {
            ...
            try
            {
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.Connection = sqlCon;
                sqlCmd.CommandText = "sp_reporteAdelantos";
                sqlCmd.CommandType = CommandType.StoredProcedure;
