...
namespace CapaDatos
{
    public class DDetalleMovimientoAlmacen
    {
        ...
        public DDetalleMovimientoAlmacen(int idDetalleMov, int idMovimiento, int idProducto, decimal cantidad, string tipoProducto, string tipoMov, string lugarSalida, decimal nroUnidades)
        {
        ...
        public string Insertar(DDetalleMovimientoAlmacen DetalleMovimiento, ref SqlConnection sqlCon, ref SqlTransaction sqlTran)
        {
            ...
            try
            {
                ...
                ParNroUnidades.Value = DetalleMovimiento.NroUnidades;
